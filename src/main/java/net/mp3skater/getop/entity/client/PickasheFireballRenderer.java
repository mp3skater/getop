...
public class PickasheFireballRenderer extends GeoProjectilesRenderer<CoolFireballEntity> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(CoolFireballEntity instance) {
        return new ResourceLocation(GetOP.MOD_ID, "textures/entity/pickashe_fireball/pickashe_fireball.png");
    }

    @Override
    public RenderType getRenderType(CoolFireballEntity animatable, float partialTicks, PoseStack stack,
