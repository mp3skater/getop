...
public class CaveStructures extends StructureFeature<JigsawConfiguration> {

    public CaveStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, CaveStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!CaveStructures.isFeatureChunk(context)) {
        ...
        blockpos = blockpos.above(topLandY - 30);
