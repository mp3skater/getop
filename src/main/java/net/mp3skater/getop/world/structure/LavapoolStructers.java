...
public class LavapoolStructers extends StructureFeature<JigsawConfiguration> {

    public LavapoolStructers() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, LavapoolStructers::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return !context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.STRONGHOLDS, context.seed(), chunkpos.x, chunkpos.z, 10);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!LavapoolStructers.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            GetOP.LOGGER.log(Level.DEBUG, "Lavapool Structures at {}", blockpos);
        }
